...
namespace AisInternalSystem
{
    ...
    {
        UCStudDetailed openstudent = new UCStudDetailed();
        ...
        public Image StudentPicture
        {
            ...
            set { _studentpicture = value; PicStud.Image = value; }
        }
        ...
        private void guna2ShadowPanel1_Click(object sender, EventArgs e)
        {
            ...
            mainform.Controls.Add(openstudent);
            mainform.Controls[mainform.Controls.IndexOf(openstudent)].BringToFront();
            mainform.Controls[mainform.Controls.IndexOf(openstudent)].Dock = DockStyle.Fill;
            openstudent.LoadStudentData(Aisid);
        }
