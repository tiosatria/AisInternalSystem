...
namespace AisInternalSystem.Module
{
    public class Data
    {
        ...
        public void AutoCompleteLoad()
        {
            ...
            {
                Db.OpenConnection();
                MySqlCommand cmd = new MySqlCommand("select * from student_data", Db.GetConnection());
                ...
                reader.Close();
                cmd = new MySqlCommand("SELECT name_of_school FROM aisDb.student_previous_school_info", Db.GetConnection());
