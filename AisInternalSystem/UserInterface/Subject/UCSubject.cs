...
namespace AisInternalSystem
{
    public partial class UCSubject : UserControl
    {
        ...
        {
            UseCustomImage = false;
            if (drop_image_Preset.SelectedItem.ToString() == "Default")
            {
                pic_subject.Image = Resources.subjectdefault;
            }
            else if (drop_image_Preset.SelectedItem.ToString() == "Biology")
            {
                pic_subject.Image = Resources.subjectBiology;
            }
            else if (drop_image_Preset.SelectedItem.ToString() == "English")
            {
                pic_subject.Image = Resources.subjectEnglish;
            }
            else if (drop_image_Preset.SelectedItem.ToString() == "Geography")
            {
                pic_subject.Image = Resources.subjectGeography;
            }
            else if (drop_image_Preset.SelectedItem.ToString() == "History")
            {
                pic_subject.Image = Resources.subjectHistory;
            }
            else if (drop_image_Preset.SelectedItem.ToString() == "Math")
            {
                pic_subject.Image = Resources.subjectMath;
            }
            else if (drop_image_Preset.SelectedItem.ToString() == "Science")
            {
                pic_subject.Image = Resources.subjectScience;
            }
            else if (drop_image_Preset.SelectedItem.ToString() == "Social")
            {
                pic_subject.Image = Resources.subjectSocial;
            }
            else if (drop_image_Preset.SelectedItem.ToString() == "Technology")
            {
