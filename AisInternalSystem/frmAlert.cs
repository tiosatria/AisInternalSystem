...
namespace AisInternalSystem
{
    public partial class frmAlert : Form
    {
        ...
        public void setAlert(string message, frmAlert.AlertType type)
        {
            this.Opacity = 0.0;
